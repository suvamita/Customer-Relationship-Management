...
<body class="error-body no-top">
    ...
    <div class="container">
        <!-- <img src="password-lock.jpg" alt=""> -->
        <div class="row login-container column-seperation">
            <div class="col-md-5 col-md-offset-1">
                <h2>Forgot Password </h2>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <p>
                    <a href="registration.php" class="text">No worries Sign up Now!</a> It's free and always will be..
                </p>
                <br>
            ...
            <div class="col-md-5 "> 
                ...
                <form id="login-form" class="login-form" action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <button class="btn btn-primary btn-cons pull-right" name="submit"
