...
<body background="bg-251.jpg" class="error-body no-top">
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Sign Up in to CRM</h2>
                      <a href="login.php"></a> 
          <br>
		 ...
		 <div class="form-group col-md-10">
            ...
            <div class="controls">
				<div class="input-with-icon  right">                                       
					<input type="text" name="name" style="color:blue" id="name" class="form-control" required="true">                                
				</div>
            </div>
          </div>
          </div>
